...
const Profile = async() => {
  ...
  <AccordionItem value="recent">
    ...
    <AccordionContent>
      <CompanionList title="Reacent Sessions" companions={sessionHistory}/>
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="companions">
    <AccordionTrigger className="text-2xl font-bold">My Padii{`(${companions.length})`}</AccordionTrigger>
    <AccordionContent>
